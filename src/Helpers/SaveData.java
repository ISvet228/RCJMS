...
public final class SaveData {
    ...
    public static void saveSettings(String language, Style theme, double renderScale, boolean vsync) throws IOException {
        Data data = load();
    ...
    private static void save(Data data) throws IOException {
        ...
        try (BufferedWriter writer = Files.newBufferedWriter(temp, StandardCharsets.UTF_8,
            ...
            writer.write("vsync=" + data.vsync); writer.newLine(); writer.newLine();
