...
public class MazeGenerator {
    ...
    public MazeGenerator(int width, int height) {//┐(￣ヘ￣;)┌
    ...
    private void carve(int x, int y) {
        ...
        for (int[] dir : directions) {
            ...
            if (nx > 0 && ny > 0 && nx < width - 1 &&
                    ny < height - 1 && maze[ny][nx] == 1) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int[] dir : dirs) {
                ...
                if (nx >= 0 && ny >= 0 && nx < width &&
                        ny < height && !visited[ny][nx] && maze[ny][nx] != 1) {
